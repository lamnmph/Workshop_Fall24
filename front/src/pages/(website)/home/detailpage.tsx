    ...
    <>
      <div className="container mx-auto p-20">
        <div className="grid grid-cols-5 gap-1">
          ...
          <div>
            <img src="image/chair.png" alt="err" width={500} />
          </div>
          <div className="pl-30">
            <p className="font-bold">Asgaard sofa</p>
            <p className="font-black text-3xl mt-5 text-red-500">25.000.000đ</p>
            <div className="flex mt-5 text-yellow-500">
              <FaStar />
              <FaStar />
              <FaStar />
              <FaStar />
          ...
          <p className="font-base flex-col">
            Setting the bar as one of the loudest speakers in its class, the
            Kilburn is a compact, stout-hearted hero with a well-balanced audio
            which boasts a clear midrange and extended highs for a sound.
            <p className="font-base text-gray-500">Size</p>
            <div className="flex ">
              <button className="border-solid border-2 bg-yellow-500 rounded-lg text-white mr-3 px-3 py-3 mr-3">
                L
              </button>
              <button className="border-solid border-2 bg-gray-400 rounded-lg text-white mr-3 px-3 py-3 mr-3">
                XL
              </button>
              <button className="border-solid border-2 bg-gray-400 rounded-lg text-white mr-3 px-3 py-3 mr-3">
                XS
            ...
            <p className="font-base text-gray-500">Color</p>
            <div className="flex ">
            ...
            <p className="font-base text-gray-400 mt-2">Tags: Sofa, Chair, Home, Shop</p>
          </p>
        </div>
